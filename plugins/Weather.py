    ...
    def handle(self, query, parsed):
        ...
        try:
            ...
            for result in results:
                tmp_min, tmp_max, cond_txt_d, cond_txt_n = result['tmp_min'], result[
                    'tmp_max'], result['cond_txt_d'], result['cond_txt_n']
                res += '{}:白天{},夜间{},气温{}到{}摄氏度;'.format(
                    day_lable[i], cond_txt_d, cond_txt_n, tmp_min, tmp_max)
                i += 1
